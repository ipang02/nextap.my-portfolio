            ...
            <div className="col-xl-12">
              <div className="tp-footer-5-content-wrap">
                ...
                <div className="tp-footer-5-info d-flex align-items-center justify-content-start justify-content-md-end">
                  <Link className="tp-footer-5-mail" href="https://api.whatsapp.com/send/?phone=601121448557&text=Hi%2C+saya+berminat+untuk+menempah+Website.&type=phone_number&app_absent=0">
                    Nextap Digital
                  </Link>
          ...
          <div className="row align-items-center">
            <div className="col-xl-3 col-lg-6 col-md-5 d-none d-xl-block">
              <div className="tp-copyright-5-left-info">
                <span>
                  <Link
                    href="https://maps.app.goo.gl/w19V9Z9DYerTrzED8"
                    target="_blank"
                  >
                ...
                <span>
                  Phone:
                  <Link href="tel:+725214456">+60 11 2144 8557</Link>
                </span>
              </div>
            </div>
            <div className="col-xl-6 col-lg-6 col-md-7">
              <div className="tp-copyright-2-social text-start text-sm-center text-xl-center">
                <Link className="mb-10" href="https://my.linkedin.com/in/nmirfan">
                  Linkedin
                </Link>
                <Link className="mb-10" href="https://www.tiktok.com/@ipang.kb?_r=1&_t=ZS-93TsY3sMHWp">
                  TikTok
                </Link>
                <Link className="mb-10" href="https://www.instagram.com/nextap.my/">
                  Instagram
                </Link>
              </div>
            </div>
            <div className="col-xl-3 col-lg-6 col-md-5">
              <div className="tp-copyright-2-left text-center text-md-end">
                <p>©{new Date().getFullYear()}- MarkeThing Digital Sdn Bhd</p>
              </div>
            </div>
          </div>
        </div>
