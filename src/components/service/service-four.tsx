...
const service_data = [
  {
    id: 1,
    title: "Branding",
    desc: "First, we learn your brand. Then, we research and design experiences that make it stand out.",
    category: ["Research", "Ui/ UX", "Prototyping"],
  },
  {
    id: 2,
    title: "Web/Mobile",
    desc: "We build web and mobile solutions that are fast, reliable, and tailored to your business needs.",
    category: ["SEO", "Creative Development", "System"],
  },
  {
    id: 3,
    title: "Digital Marketing",
    desc: "We optimize your brand’s visibility online, driving the right traffic through search engine marketing and targeted advertising.",
    category: ["Creative", "Digital strategy", "Ads"],
  },
];
