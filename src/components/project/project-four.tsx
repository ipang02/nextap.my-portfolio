...
// images
import port_1 from "@/assets/img/home-03/portfolio/port-1-cs.jpg";
import port_2 from "@/assets/img/home-03/portfolio/port-2-cs.jpg";
...
const project_data = [
  {
    ...
    img_1: port_1,
    img_2: port_2,
    meta: "FEB 2026 . Web/Mobile Development",
    title: "COMING SOON",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    img_1: port_5,
    img_2: port_6,
    meta: "JAN 2026 . Branding & Marketing",
    title: "MA Homes Trading",
  },
  {
    id: 4,
    img_1: port_7,
    img_2: port_8,
    meta: "MAY 2024 . Branding & Marketing",
    title: "Repeat Recipe",
  },
];
                  ...
                  <div className="col-xl-4 col-lg-4 col-md-12 order-1 order-lg-0">
                    <div className="tp-project-3-content text-center">
                      ...
                      <Link
                        ...
                        href="/portfolio-details-1-error"
                      >
                        See Project
                      </Link>
                    </div>
